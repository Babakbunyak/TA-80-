        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p><?= esc($berita['teks_berita']) ?></p>
                </div>
                <div class="col-md-4">
                    <?php
                    $gambarFile = $berita['foto'] ?? '';
                    $gambarPath = FCPATH . 'uploads/berita/' . $gambarFile;
                    $gambarURL  = base_url('uploads/berita/' . $gambarFile);
                    ?>

                    <?php if (!empty($gambarFile) && file_exists($gambarPath)): ?>
                        <img src="<?= esc($gambarURL) ?>" alt="Gambar Berita" class="img-fluid rounded mb-4">
                    <?php else: ?>
                        <div class="alert alert-warning">
                            <i class="bi bi-image"></i> <em>Gambar tidak tersedia.</em>
                        </div>
                    <?php endif; ?>
                </div>
